...
public class IntegrationTest : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public IntegrationTest(WebApplicationFactory<Program> factory)
    {
        ...
        _clientTest = factory.WithWebHostBuilder(builder =>
        {
            ...
            {
                var descriptor = services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<HotelManagerContext>));
                if (descriptor != null)
                {
                ...
                services.AddScoped<IHotelManagerContext, ContextTest>();
                ...
                using (var appContext = scope.ServiceProvider.GetRequiredService<ContextTest>())
                {
                    ...
                    appContext.Hotels.Add(new Hotel { HotelId = 1, Name = "HotelManager Hotel Manaus", Address = "Address 1", CityId = 1 });
                    appContext.Hotels.Add(new Hotel { HotelId = 2, Name = "HotelManager Hotel Palmas", Address = "Address 2", CityId = 2 });
                    appContext.Hotels.Add(new Hotel { HotelId = 3, Name = "HotelManager Hotel Ponta Negra", Address = "Addres 3", CityId = 1 });
                    appContext.SaveChanges();
                    ...
                    appContext.SaveChanges();
                    appContext.Users.Add(new User { UserId = 1, Name = "Ana", Email = "ana@HotelManager.com", Password = "Senha1", UserType = "admin" });
                    appContext.Users.Add(new User { UserId = 2, Name = "Beatriz", Email = "beatriz@HotelManager.com", Password = "Senha2", UserType = "client" });
                    appContext.Users.Add(new User { UserId = 3, Name = "Laura", Email = "laura@HotelManager.com", Password = "Senha3", UserType = "client" });
                    appContext.SaveChanges();
